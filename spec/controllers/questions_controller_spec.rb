  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved question as @question" do
        ...
        post :create, {:question => { "level" => "invalid value" }}, valid_session
        expect(assigns(:question)).to be_a_new(Question)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested question" do
        ...
        expect_any_instance_of(Question).to receive(:update).with({ "level" => "" })
        put :update, {:id => question.to_param, :question => { "level" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the question as @question" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Question).to receive(:save).and_return(false)
        put :update, {:id => question.to_param, :question => { "level" => "invalid value" }}, valid_session
        expect(assigns(:question)).to eq(question)
      end
