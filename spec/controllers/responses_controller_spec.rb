  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved response as @response" do
        ...
        post :create, {:response => { "user" => "invalid value" }}, valid_session
        expect(assigns(:response)).to be_a_new(Response)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested response" do
        ...
        expect_any_instance_of(Response).to receive(:update).with({ "user" => "" })
        put :update, {:id => response.to_param, :response => { "user" => "" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the response as @response" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        allow_any_instance_of(Response).to receive(:save).and_return(false)
        put :update, {:id => response.to_param, :response => { "user" => "invalid value" }}, valid_session
        expect(assigns(:response)).to eq(response)
      end
